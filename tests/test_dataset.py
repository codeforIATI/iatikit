...
class TestDatasets(TestCase):
    def __init__(self, *args, **kwargs):
        ...
        self.registry_path = join(dirname(abspath(__file__)), "fixtures", "registry")
...
class TestDataset(TestCase):
    def __init__(self, *args, **kwargs):
        ...
        self.old_org_acts = Dataset(
            join(registry_path, "data", "old-org", "old-org-acts.xml"),
            join(registry_path, "metadata", "old-org", "old-org-acts.json"),
        )

        self.fixture_org_acts = Dataset(
            join(registry_path, "data", "fixture-org", "fixture-org-activities.xml"),
            join(
                registry_path, "metadata", "fixture-org", "fixture-org-activities.json"
            ),
        )
    ...
    def test_dataset_validate_codelists_old(self, fake_logger_warning):
        ...
        msg = (
            "Can't perform codelist validation for " + "IATI version %s datasets.",
            "1.03",
        )
    ...
    def test_metadata(self):
        ...
        assert dataset_metadata.get("extras").get("publisher_organization_type") == "21"

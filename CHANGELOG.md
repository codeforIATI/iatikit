...
- Don’t error if a metadata file is unexpectedly missing (thanks to [@Bjwebb](https://github.com/Bjwebb) and [@jarofgreen](https://github.com/jarofgreen) in [#72](https://github.com/codeforIATI/iatikit/issues/72))
